...
bool Location::ajouter()
{
    QSqlQuery query;
      ...
      query.prepare("INSERT INTO LOCATIONS2 (IDLOC, IDRES, KM_DEPART,KM_ARRIVEE ,CARB_DEPART ,"
                    "CARB_ARRIVEE,CAUTION,RESTE_A_PAYER) "
                    "VALUES (:IDLOC,:IDRES,:KM_DEPART,:KM_ARRIVEE,:CARB_DEPART,"
                    ":CARB_ARRIVEE,:CAUTION,:RESTE_A_PAYER)");
...
bool Location::modifier_location()
{
    ...
    QString VRaP=QString::number(RaP);
      ...
      query.prepare("UPDATE LOCATIONS2 SET IDLOC=:IDLOC, IDRES=:IDRES, KM_DEPART=:KM_DEPART,"
