...
vignette::vignette(int code,QString matricule,QDateTime dateDeb,QDateTime dateExp,double prix,int courante)
{
    this->code=code;
...
QSqlQueryModel* vignette::afficher()
{
    QSqlQueryModel *model = new QSqlQueryModel;
      model->setQuery("SELECT v.CODE,v.MATRICULE,vt.MARQUE,vt.MODELE,v.DATE_DEB,"
                      "v.DATE_EXP,v.PRIX,v.courante FROM vignette v INNER JOIN voitures vt "
      ...
      model->setHeaderData(7, Qt::Horizontal, QObject::tr("Courante"));
...
bool vignette::ajouter()
{
    QSqlQuery query;
      ...
      query.prepare("INSERT INTO vignette (CODE, MATRICULE, DATE_DEB,DATE_EXP ,PRIX ,COURANTE) "
                    "VALUES (:CODE,:MATRICULE,:DATE_DEB,:DATE_EXP ,:PRIX ,:COURANTE)");
